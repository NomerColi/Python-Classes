...
class BinaryHeap(Queue, Tree):
  ...
  def _in_order(self, i):
    ...
    r_idx = right(i)
    if 0 <= l_idx < self.n:
      indices += self._in_order(l_idx)
    if 0 <= i < self.n:
      indices.append(i)
    if 0 <= r_idx < self.n:
      indices += self._in_order(r_idx)
    return indices
  ...
  def _post_order(self, i):
    ...
    r_idx = right(i)
    if 0 <= l_idx < self.n:
      indices += self._post_order(l_idx)
    if 0 <= r_idx < self.n:
      indices += self._post_order(r_idx)
    if 0 <= i < self.n:
      indices.append(i)
    return indices
  ...
  def _pre_order(self, i):
    ...
    if 0 <= i < self.n:
      indices.append(i)
    if 0 <= l_idx < self.n:
      indices += self._pre_order(l_idx)
    if 0 <= r_idx < self.n:
      indices += self._pre_order(r_idx)
